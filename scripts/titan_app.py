...
class UnifiedChatbotUI:
    def __init__(self, api_keys=None):
        ...
        self.hBrushInner = win32gui.CreateSolidBrush(win32api.RGB(18, 18, 26))
        self.hBrushKey = win32gui.CreateSolidBrush(win32api.RGB(255, 0, 255)) # transparent key

        # Register and create native window
        self._create_native_window()

        # Start key listeners & trackers
    ...
    def _create_native_window(self):
        ...
        # 2. Sizing & Positioning matching final.py exactly (scaled by DPI)
        ...
        set_window_exclude_from_capture(self.hwnd)

        # 4. Edit Control (styled to match padding and color)
